...
description: There are some cases where you might want to implement a validation method for your Sequelize model that queries other rows in your database to check business rules.
pubDate: 'Aug 23 2019'
---
...
<Terminal content={`
  Executing (<text-green-400>1988c02b-2fdb-4a36-afc2-e7e01895e691</text-green-400>):
START TRANSACTION;
Executing (<text-green-400>1988c02b-2fdb-4a36-afc2-e7e01895e691</text-green-400>):
...
Executing (<text-cyan-400>default</text-cyan-400>):
...
Executing (<text-green-400>1988c02b-2fdb-4a36-afc2-e7e01895e691</text-green-400>):
ROLLBACK;
<text-red-500>(node:29502) UnhandledPromiseRejectionWarning: SequelizeValidationError: Validation error: Cannot read property 'age' of null</text-red-500>
`} />
